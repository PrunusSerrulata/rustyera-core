...
pub use markup::{
    HtmlAlignment, HtmlAttribute, HtmlBoxModel, HtmlColorMatrix, HtmlDecodedSource,
    HtmlDisplayMode, HtmlDocument, HtmlElementKind, HtmlElementSemantic, HtmlError, HtmlErrorKind,
    HtmlFontEdging, HtmlFontHinting, HtmlInteraction, HtmlLength, HtmlLengthCut,
    ...
    HtmlSubstringPlan, HtmlSubstringPoll, HtmlSubstringResult, HtmlTextRenderIntent,
    HtmlTextRenderer, HtmlVerticalAlignment, HtmlWarning, HtmlWarningKind, decode_query_entities,
    html_string_length_units, parse_document, parse_document_with_source_map,
    parse_document_with_warnings, reject_snake_extensions, serialize_document,
    snake_extension_range,
};
