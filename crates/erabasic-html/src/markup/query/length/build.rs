...
use probe::{Style, canonical_mapping, inline_style, shallow_node, text_document};
use std::collections::BTreeMap;

pub(super) struct Built {
    pub(super) probes: Vec<HtmlLengthProbe>,
    pub(super) parts: Vec<Part>,
    pub(super) layouts: Vec<Layout>,
    pub(super) root_layout: usize,
    pub(super) work_bytes: usize,
    pub(super) measurement_units: usize,
}
...
impl<'a> Builder<'a> {
    ...
    fn division(
        ...
        self.atomic(
            ...
            PartKind::Division {
                absolute: *display != super::super::super::HtmlDisplayMode::Relative,
            },
            state,
        )
    }
