// Latin/page-mask/supplementary: dotnet/runtime v8.0.28, MIT. BMP: UnicodeData15.
// Preserve licenses/DOTNET-LICENSE.TXT and licenses/ICU4X-LICENSE.
// and THIRD-PARTY-NOTICES.TXT when integrating. Source-generated; not executed or verified.
// BMP simple uppercase is fixed to Unicode 15 / ICU72; provider/environment and
// mapped data bindings are recorded in the integration manifest. Behavioral
// parity is still pending the authorized oracle, not inferred from those bindings.
pub(super) const LATIN_UPPER: [u16; 256] = [
...
pub(super) const NO_CASING_PAGES: [u8; 32] = [
...
pub(super) const ICU72_BMP_SIMPLE_UPPER: &[(u16, u16)] = &[
    (0x61, 0x41),
    (0x62, 0x42),
    (0x63, 0x43),
    (0x64, 0x44),
...
pub(super) const DOTNET_SUPPLEMENTARY: &[(u32, u32)] = &[
    (0x10428, 0x10400),
    (0x10429, 0x10401),
    (0x1042a, 0x10402),
    (0x1042b, 0x10403),
