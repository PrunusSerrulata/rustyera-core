...
use era_runtime_protocol::{
    ...
    SQL_OPERATION_VERSIONS, SerializePhysicalHistoryRequest, SerializePhysicalHistoryResponse,
    ServerHello, ServiceCapability, ServiceKind, ServiceRequest, ServiceResponse, ServiceResult,
    ShutdownReady, SnapshotExportPurpose, SnapshotIneligibleReason, StartMode, StartRequest,
