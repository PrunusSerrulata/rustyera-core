...
use era_runtime_protocol::{
    ...
    ProjectLoadReport, ProjectLoadRequest, ProjectionIntegerResponse, ProjectionObservation,
    ProjectionQueryContext, ProjectionState, ProjectionStringIndexRequest,
