...
`7b69ebd27378c03c32b6477b74901bfc3d33223c`。当前 analyzer、compiler、协议、VM
...
2026-09-11 基准升级未修改上游输入等待实现；本文引用的旧版 fixture 保留采集时 SHA，
本次未重新运行输入测试。新基准增量见[参考映射](runtime-reference-mapping.zh-CN.md#2026-09-11-原版基准升级)。
